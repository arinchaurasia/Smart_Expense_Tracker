/* BudgetMind Serverless API: Gemini Financial Advice Handler */
...
export default async function handler(req, res) {
    ...
    try {
        ...
        const url = `https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-latest:generateContent?key=${apiKey}`;
